...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void saveUser(String name, String lastName, byte age) {
        try {
            PreparedStatement preparedStatement = Util.utilConnection().prepareStatement("insert into users(name, lastName, age) values(?,?,?)");
    ...
    public void removeUserById(long id) {
        try {
            PreparedStatement preparedStatement = Util.utilConnection()
